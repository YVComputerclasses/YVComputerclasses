function showPopup(service) {
  ...
  if (service === "A") {
    ...
    docList.innerHTML = `
      ...
      <li>મોબાઈલ નંબર</li>
      <li>ઈમેલ આઈડી</li>
      <li>એગ્રીમેન્ટ સ્ટેમ્પ (વકીલ દ્વારા બનાવેલ)[એક કરતા વધારે માલિક હોય તો સંમતિ પત્રક].</li>
      <li>લાઈટ બીલ.</li>
      <li>ઘરની આકારણી.</li>
      <li>આધાર કાર્ડ.</li>
...
સબંધિત આંગણવાડીનાં આંગણવાડી વર્કર અથવા સરકારશ્રી દ્વારા પ્રમાણિત કરેલ દાખલો રજુ કરવો. ]</li>
    ...
    popupTitle.textContent = "ધંધા નું પ્રમાણ પત્ર મેડવા માટે";
    docList.innerHTML = `
    <li>પાસપોર્ટ સાઈઝ કલર ફોટોગ્રાફ.</li>
    <li>મોબાઈલ નંબર</li>
    <li>ઈમેલ-આઈડી</li>
    <li>આધાર કાર્ડ</li>
    <li>પાન કાર્ડ</li>
    <li>એક વર્ષ નું ટન ઓવર રકમ</li>
    <li>વ્યવસાય નુ નામ</li>
    <li>વ્યવસાય નું સરનામું</li>
    <li>વ્યવસાય નો બિલ સ્લિપ</li>
    <li>વ્યવસાય નો લોગો</li>
    <li>માલિક ની બેંક પાસબૂક</li>
    <li>વ્યવસાય નું લોકેશન</li>
    `;
    extraInfo.textContent = "દરેક દસ્તાજેજ ની 1 ક્ષેરોક્ષ સાથે લાવી. આભાર";
  }else if (service === "W") {
    popupTitle.textContent = "ગ્રામ રક્ષક દળ (GRD)";
    docList.innerHTML = `
      <li>પાસપોર્ટ સાઈઝ કલર ફોટોગ્રાફ.</li>
      <li>આધાર કાર્ડ.</li>
      <li>ચુંટણી કાર્ડ.</li>
      <li>શાળા છોડ્યાનું પ્રમાણપત્ર (LC) અથવા જન્મ તારીખનું સર્ટિફિકેટ</li>
      <li>લાયકાત મુજબની છેલ્લી માર્કશીટ અને પ્રમાણપત્ર</li>
      <li>ગ્રામપંચાયત નો રહેવાસી નો દાખલો</li>
      <li>સ્થાનિક પોલીસ સ્ટેશન દ્વારા આપવામાં આવેલ પોલીસ વેરીફિકેશન અથવા ગુનાહિત ઈતિહાસ ન હોવા અંગેનો રિપોર્ટ</li>
      <li>બેંક પાસબુક</li>
    `;
    extraInfo.textContent = "દરેક દસ્તાજેજ ની 1 ક્ષેરોક્ષ સાથે લાવી. આભાર";
  }else if (service === "X") {
    popupTitle.textContent = "ગુજરાત આંગણવાડી ભરતી";
    docList.innerHTML = `
      <li>પાસપોર્ટ સાઇઝનો ફોટો અને સહી.</li>
      <li>આધાર કાર્ડ.</li>
      <li>ચુંટણી કાર્ડ.</li>
      <li>શાળા છોડ્યાનું પ્રમાણપત્ર (LC) અથવા જન્મ તારીખનું સર્ટિફિકેટ</li>
      <li>ધોરણ ૧૦ (S.S.C.) ની માર્કશીટ અને સર્ટિફિકેટ (આંગણવાડી તેડાગર (Helper) ની પોસ્ટ માટે ફરજિયાત).</li>
      <li>ધોરણ ૧૨ (H.S.C.) ની માર્કશીટ અને સર્ટિફિકેટ (આંગણવાડી કાર્યકર (Worker) ની પોસ્ટ માટે ફરજિયાત).</li>
      <li>કોલેજ અથવા ડિપ્લોમાની માર્કશીટ (જો તમે સ્નાતક કે તેનાથી વધુ અભ્યાસ કર્યો હોય અને તેના મેરિટ ગુણ મેળવવા માંગતા હોવ તો).</li>
      <li>ટ્રાયલ સર્ટિફિકેટ (જો તમે એક કરતાં વધુ પ્રયત્ને પરીક્ષા પાસ કરી હોય, તો તમામ ટ્રાયલની માર્કશીટ).</li>
      <li>ગ્રેડ કન્વર્ઝન પ્રમાણપત્ર (જો તમારી માર્કશીટમાં ગુણના બદલે ગ્રેડ (Grade/CGPA) આપેલા હોય, તો તેને ગુણમાં બદલવાનું પ્રમાણપત્ર)1.</li>
      <li>ગ્રામપંચાયત નો રહેવાસી નો દાખલો</li>
      <li>જાતિનો દાખલો (જો તમે SC, ST, અથવા SEBC/OBC કેટેગરીમાં આવતા હોવ તો).</li>
      <li>નોન-ક્રીમીલેયર સર્ટિફિકેટ (ફક્ત SEBC/OBC વર્ગના ઉમેદવારો માટે).</li>
      <li>વિધવા હોવા અંગેનું પ્રમાણપત્ર: જો લાગુ પડતું હોય તો (આ ઉમેદવારોને મેરિટમાં અગ્રતા/વધારાના ગુણ મળે છે).</li>
    `;
    extraInfo.textContent = "દરેક દસ્તાજેજ ની 1 ક્ષેરોક્ષ સાથે લાવી. આભાર";
  }
